...
class MainMenu(Scene):
    def __init__(self, game: Game) -> None:
        ...
        self.add(Button(self, (520, 610), "+", 80, self.increase_gamma, scale=0.5))
        ...
        self.title_texture = Texture(self.game.window, assets.fonts[150].render("Umbral", True, (222, 222, 222)))
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        self.game.texture.blit(self.title_texture, ((self.game.window.size[0] - self.title_texture.size[0]) // 2, 110))
        self.game.texture.blit(self.gamma_texture, ((self.game.window.size[0] - self.gamma_texture.size[0]) // 2, 595))
        self.game.texture.blit(self.gamma_hint_texture, ((self.game.window.size[0] - self.gamma_hint_texture.size[0]) // 2, 700))
